-- 社区养老服务系统数据库初始化脚本
SET SQL_MODE = '';
DROP DATABASE IF EXISTS elderlycare;
CREATE DATABASE elderlycare DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE elderlycare;

-- 用户表(老人、家属、社区管理员、服务人员)
...
('健康护理', '提供健康护理和康复服务', 'health', 2, 1),
('精神慰藉', '提供精神陪伴和心理疏导服务', 'mind', 3, 1),
('法律咨询', '提供法律咨询和援助服务', 'law', 4, 1);

-- 初始化服务项目数据
INSERT INTO service_item (category_id, name, description, price, duration, status) VALUES
(1, '助餐服务', '为老人提供送餐、做饭服务', 30.00, 60, 1),
(1, '助浴服务', '为老人提供洗浴辅助服务', 50.00, 45, 1),
(1, '助洁服务', '为老人提供居家清洁服务', 40.00, 90, 1),
(1, '陪诊服务', '陪同老人就医取药', 60.00, 120, 1),
(2, '血压监测', '定期为老人测量血压', 20.00, 20, 1),
(2, '血糖监测', '定期为老人测量血糖', 20.00, 20, 1),
(2, '康复护理', '专业康复护理服务', 80.00, 60, 1),
(2, '用药指导', '专业用药指导服务', 30.00, 30, 1),
(3, '陪伴聊天', '与老人进行情感交流', 40.00, 60, 1),
(3, '心理疏导', '专业心理咨询服务', 100.00, 60, 1),
(3, '文化娱乐', '组织文化娱乐活动', 0.00, 120, 1),
(4, '法律咨询', '提供法律咨询服务', 50.00, 60, 1),
(4, '纠纷调解', '帮助调解家庭纠纷', 80.00, 90, 1);

-- 初始化管理员账号 (密码: admin123)
INSERT INTO sys_user (username, password, real_name, phone, user_type, status) VALUES
('admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iAt7IIue', '系统管理员', '13800000000', 3, 1);

-- 初始化联调用服务人员账号 (密码: Service123!)
INSERT INTO sys_user (username, password, real_name, phone, user_type, status) VALUES
('service_dev', '$2a$10$yzlr21yv9uDwa1bPtVXHNuE4pxXRZerE8U/S5lMU/jm33VmAk9.rG', '联调服务人员', '13920009999', 4, 1);
